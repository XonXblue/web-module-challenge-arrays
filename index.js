...
function addFlavor(arr, strings){
   return (arr.unshift(strings));
...
function removeLastFlavor(arr, strings){
   return(arr.shift(strings));
   removeLastFlavor.shift
}
...
function removeFlavorByName(){
    return(removeFlavorByName.splice(originalFlavors,'Trick Oreo Treat'))
}
